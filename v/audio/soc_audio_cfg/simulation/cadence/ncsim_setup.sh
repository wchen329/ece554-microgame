...
# ACDS 18.1 625 win32 2019.11.29.19:42:22
...
# ----------------------------------------
# If soc_audio_cfg is one of several IP cores in your
...
if [ $SKIP_COM -eq 0 ]; then
  ...
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/soc_audio_cfg_audio_and_video_config_0.v"         -work audio_and_video_config_0 -cdslib ./cds_libs/audio_and_video_config_0.cds.lib
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/soc_audio_cfg.v"                                                                                                                               
fi
