...
# ACDS 18.1 625 win32 2019.11.29.19:53:38
...
# ----------------------------------------
# If soc_audio_clk is one of several IP cores in your
...
if [ $SKIP_COM -eq 0 ]; then
  ...
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/soc_audio_clk_audio_pll_0_audio_pll.vo"      -work audio_pll         -cdslib ./cds_libs/audio_pll.cds.lib        
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/soc_audio_clk_audio_pll_0.v"                 -work audio_pll_0       -cdslib ./cds_libs/audio_pll_0.cds.lib      
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/soc_audio_clk.v"                                                                                                            
fi
