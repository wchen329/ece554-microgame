...
TOP_LEVEL_NAME="soc_audio_lrclk"
QSYS_SIMDIR="./../"
...
mkdir -p ./libraries/intel_up_avalon_audio_clks_0/
...
if [ $SKIP_COM -eq 0 ]; then
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/soc_audio_lrclk_intel_up_avalon_audio_clks_0.v" -work intel_up_avalon_audio_clks_0 -cdslib ./cds_libs/intel_up_avalon_audio_clks_0.cds.lib
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/soc_audio_lrclk.v"                                                                                                                                   
fi
