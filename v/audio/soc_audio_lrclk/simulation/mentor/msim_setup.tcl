...
# ----------------------------------------
# If soc_audio_lrclk is one of several IP cores in your
...
# ----------------------------------------
# ACDS 18.1 625 win32 2019.11.29.19:44:42
...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "soc_audio_lrclk"
}
...
ensure_lib                              ./libraries/intel_up_avalon_audio_clks_0/
vmap       intel_up_avalon_audio_clks_0 ./libraries/intel_up_avalon_audio_clks_0/
...
alias com {
  echo "\[exec\] com"
  eval  vlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/soc_audio_lrclk_intel_up_avalon_audio_clks_0.v" -work intel_up_avalon_audio_clks_0
  eval  vlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/soc_audio_lrclk.v"                                                                           
}
...
alias elab {
  echo "\[exec\] elab"
  eval vsim -t ps $ELAB_OPTIONS $USER_DEFINED_ELAB_OPTIONS -L work -L work_lib -L intel_up_avalon_audio_clks_0 -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L cyclonev_ver -L cyclonev_hssi_ver -L cyclonev_pcie_hip_ver $TOP_LEVEL_NAME
}
...
alias elab_debug {
  ...
  eval vsim -novopt -t ps $ELAB_OPTIONS $USER_DEFINED_ELAB_OPTIONS -L work -L work_lib -L intel_up_avalon_audio_clks_0 -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L cyclonev_ver -L cyclonev_hssi_ver -L cyclonev_pcie_hip_ver $TOP_LEVEL_NAME
}
